...
function Hero() {
    return ( 
        <div className="container">
            <div className="row text-muted mt-5 mb-5 p-5">
            ...
            <div className="row text-muted p-5 mt-5 border-top" style={{lineHeight:"1.8"}}>
               ...
               <div className="col-6 mt-5 p-5">
                ...
                <p> <a href="">Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
                 ...
                 <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="">blog</a> or see what the media is saying <a href="">about us.</a>
                </p>
               </div>
            </div>
